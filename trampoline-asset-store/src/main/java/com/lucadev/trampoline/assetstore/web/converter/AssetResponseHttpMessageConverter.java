...
public class AssetResponseHttpMessageConverter
	...
	/**
	 * If we can read and convert to the specified class.
	...
	/**
	 * If we can write to the specified class and mediatype.
	...
	/**
	 * Get the supported mediatypes for this converter.
