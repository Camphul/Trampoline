...
public abstract class AbstractResponseEntityExceptionHandler
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
			...
			WebRequest request) {
		log.debug("#handleMethodArgumentNotValid: advice for {}",
				ex.getClass().getName());
	...
	protected ResponseEntity<Object> handleMissingServletRequestPart(
			...
			WebRequest request) {
		log.debug("#handleMissingServletRequestPart: advice for {}",
				ex.getClass().getName());
	...
	protected ResponseEntity<Object> handleMissingServletRequestParameter(
		...
		log.debug("#handleMissingServletRequestParameter: advice for {}",
				ex.getClass().getName());
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(
			...
			WebRequest request) {
		log.debug("#handleNoHandlerFoundException: advice for {}",
				ex.getClass().getName());
	...
	protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(
			...
			HttpStatus status, WebRequest request) {
		log.debug("#handleHttpRequestMethodNotSupported advice for {}",
				ex.getClass().getName());
		//
	...
	protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(
			...
			WebRequest request) {
		log.debug("#handleMediaTypeNotSupported: advice for {}", ex.getClass().getName());
		StringBuilder builder = new StringBuilder();
