...
(
    ...
    CONSTRAINT fkb_user_id_user_role FOREIGN KEY (user_id) REFERENCES trampoline_user (id),
    CONSTRAINT fkb_role_id_user_role FOREIGN KEY (role_id) REFERENCES trampoline_role (id),
...
(
    ...
    CONSTRAINT fkb_role_id_role_privilege FOREIGN KEY (role_id) REFERENCES trampoline_role (id),
    CONSTRAINT fkb_privilege_id_role_privilege FOREIGN KEY (privilege_id) REFERENCES trampoline_privilege (id),
